...
namespace CUE4Parse.FileProvider
{
    public class OsGameFile : GameFile
    {
        ...
        public OsGameFile(DirectoryInfo baseDir, FileInfo info, UE4Version ver, EGame game)
            : base(info.FullName.Substring(baseDir.FullName.Length + 1).Replace('\\', '/'), info.Length, ver, game)
        {
            ActualFile = info;
        }
