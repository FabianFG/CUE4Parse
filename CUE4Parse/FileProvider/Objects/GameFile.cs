...
{
    public static readonly string[] LegacyUePackageExtensions = ["upk", "xxx", "XXX", "udk", "u", "mbamap", "sword", "mars", "apb", "rbd", "aa3", "ut3", "ut2", "utx", "unr", "umx", "uax", "usx", "ukx", "map", "lm", "s8m", "ccpk", "mo"];
