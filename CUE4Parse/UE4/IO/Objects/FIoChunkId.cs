...
public readonly struct FIoChunkId(ulong chunkId, ushort chunkIndex, byte chunkType) : IEquatable<FIoChunkId>
{
    // NETWORK_ORDER16
    public readonly ulong ChunkId = chunkId;
    private readonly ushort _chunkIndex = (ushort) ((chunkIndex & 0xFF) << 8 | (chunkIndex & 0xFF00) >> 8);
    private readonly byte _padding = 0;
    public readonly byte ChunkType = chunkType;
