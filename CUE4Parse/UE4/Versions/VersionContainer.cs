...
namespace CUE4Parse.UE4.Versions
{
    public class VersionContainer : ICloneable
    {
        ...
        private void InitOptions()
        {
            ...
            Options["SoundWave.UseAudioStreaming"] = Game >= GAME_UE4_25 && Game != GAME_UE4_28 && Game != GAME_GTATheTrilogyDefinitiveEdition && Game != GAME_ReadyOrNot && Game != GAME_BladeSoul; // A lot of games use this, but some don't, which causes issues.
