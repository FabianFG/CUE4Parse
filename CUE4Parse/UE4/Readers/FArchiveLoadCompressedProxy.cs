...
public class FArchiveLoadCompressedProxy(string name, byte[] compressedData, string compressionFormat, ECompressionFlags flags = COMPRESS_None, VersionContainer? versions = null) : FArchive(versions)
{
    private readonly byte[] _compressedData = compressedData;
    private int _currentIndex;
    private readonly byte[] _tmpData = new byte[LOADING_COMPRESSION_CHUNK_SIZE];
    private int _tmpDataPos = LOADING_COMPRESSION_CHUNK_SIZE;
    private int _tmpDataSize = LOADING_COMPRESSION_CHUNK_SIZE;
    private bool _shouldSerializeFromArray;
    private long _rawBytesSerialized;
    private readonly string _compressionFormat = compressionFormat;
    private readonly ECompressionFlags _compressionFlags = flags;
