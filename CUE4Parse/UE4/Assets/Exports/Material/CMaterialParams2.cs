...
public class CMaterialParams2
{
    ...
    [
        [
            "Trunk_BaseColor", "ShadedDiffuse", "LitDiffuse", "Base Colour", "CLRM", "Diffuse_Map", "Base Color",
    ...
    [
        [
            "Trunk_Normal", "T_Normal", "normal", "normalmap", "NRRO", "Base Normal",
            ...
            "Base_Normal", "BaseNormal", "Normal Base", "NormalVT", "TextureNormal", "Tex_BakedNormal", "TexNor",
