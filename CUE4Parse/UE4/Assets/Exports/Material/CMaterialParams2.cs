...
public class CMaterialParams2
{
    ...
    [
        [
            ...
            "AlbedoColour", "BCR", "Base Texture", "BaseColour", "Color Map",
            ...
            "Decal Base Color & Alpha", "Char_Diffuse", "RimDiffuse"
        ],
    ...
    [
        [
            ...
            "Normal(HrNM)_Texture", "VT Normal", "L01.Normal.Metallic.Roughness", "NRA", "Char_Normal", "RimNormal"
        ],
    ...
    [
        [
            ...
            "EmmisiveColor_A", "TextureEmissive", "TexEm", "Main_T_Emissive", "VT Emissive", "Char_Emissive", "TireEmmisive"
        ],
