...
public class FPropertyTagData
{
    ...
    internal FPropertyTagData(FArchive Ar, string type, string name = "")
    {
        Name = name;
        Type = type;
        switch (type)
    ...
    public override string ToString()
    {
        ...
        switch (Type)
        {
            ...
            case "ArrayProperty":
            case "SetProperty":
                sb.Append($"<{InnerTypeData?.ToString() ?? InnerType}>");
                break;
            case "MapProperty":
                sb.Append($"<{InnerTypeData?.ToString() ?? InnerType}, {ValueTypeData?.ToString() ?? ValueType}>");
                break;
        }
