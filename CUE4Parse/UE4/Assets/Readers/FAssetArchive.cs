...
public class FAssetArchive(FArchive baseArchive, IPackage owner, int absoluteOffset = 0, Dictionary<PayloadType, Lazy<FAssetArchive?>>? payloads = null) : FArchive(baseArchive.Versions)
{
    private readonly Dictionary<PayloadType, Lazy<FAssetArchive?>> _payloads = payloads ?? new Dictionary<PayloadType, Lazy<FAssetArchive?>>();
    private readonly FArchive _baseArchive = baseArchive;
    ...
    public readonly IPackage Owner = owner;
    public int AbsoluteOffset = absoluteOffset;
