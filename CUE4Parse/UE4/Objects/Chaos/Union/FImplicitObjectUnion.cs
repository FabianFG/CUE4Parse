...
public class FImplicitObjectUnion : FImplicitObject
{
    ...
    public override void Serialize(FChaosArchive Ar)
    {
        ...
        if (FExternalPhysicsCustomObjectVersion.Get(Ar) <
            FExternalPhysicsCustomObjectVersion.Type.UnionObjectsCanAvoidHierarchy)
        {
            throw new NotImplementedException();
        }
        else if (FFortniteMainBranchObjectVersion.Get(Ar) <
                 FFortniteMainBranchObjectVersion.Type.ChaosImplicitObjectUnionBVHRefactor)
        {
            throw new NotImplementedException();
        }
        else
