...
public readonly struct FSoftObjectPath : IUStruct, ISerializable
{
    ...
    private readonly FTopLevelAssetPath InternalTLAssetPath;
    ...
    public FSoftObjectPath(FAssetArchive Ar)
    {
        ...
        if (Ar.Ver >= EUnrealEngineObjectUE5Version.FSOFTOBJECTPATH_REMOVE_ASSET_PATH_FNAMES)
        {
            InternalTLAssetPath = new FTopLevelAssetPath(Ar);
            AssetPathName = new FName(InternalTLAssetPath.ToString());
        }
        else
        {
    ...
    public void Serialize(FArchiveWriter Ar)
    {
        ...
        // if (Ar.Ver >= EUnrealEngineObjectUE5Version.FSOFTOBJECTPATH_REMOVE_ASSET_PATH_FNAMES)
        // {
            Ar.Serialize(InternalTLAssetPath);
        // }
        // else
        // {
        //     Ar.Serialize(AssetPathName);
        // }

        // TODO: FString
        // Ar.WriteFString(SubPathString);
    }
