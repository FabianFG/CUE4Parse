...
// Restores to standard 5.4 Lua structure
public static class NRCLuaWriter
{
    ...
    private static void WriteHeader(FLuaArchiveWriter writer, LuaHeader h)
    {
        ...
        writer.Write(LuaVersion); // Header is the same except the version
    ...
    private static void WriteFunction(FLuaArchiveWriter writer, LuaFunction f)
    {
        ...
        writer.Write(255); // MaxStackSize, I had to increase it manually for some reason
